...
<div data-options="region:'north',split:true,border:false" class="layout-north">
    <div class="logo">
        <img src="/Public/img/logo.png" alt="CRM 客户关系管理系统">
    </div>
    <div class="info">
    ...
    <form id="password-edit" class="easyui-dialog">
        <input type="hidden" id="user-id" value="<?php echo session('admin')['id'];?>">
        <table class="form-table" style="max-width: 420px;">
            ...
            <tr>
                ...
                <td class="input">
                    <input type="text" id="user-name" class="easyui-textbox" value="<?php echo session('admin')['accounts'];?>">
                </td>
            </tr>
            <tr>
